...
?>
  ...
  <body>
    ...
    <h4 style="text-align: center;"><?= $dari ?> SAMPAI DENGAN <?= $sampai ?> </h4>
    <br>
    ...
    <table class="table bordered">
      ...
      <tbody>
        ...
        WHERE tanggal_surat_diterima >= '$dari' 
        AND tanggal_surat_diterima <= '$sampai'
    ...
    $bulan_dari = $bulan[$month];
    $bulan_sampai = $bulan[$month];
