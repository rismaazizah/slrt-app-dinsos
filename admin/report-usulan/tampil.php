 ...
 <div class="container-fluid">
   ...
   <!-- Page Heading -->
   <h1 class="h3 mb-4 text-gray-800">Rekap Data Usulan </h1>
              ...
              ?>
               <tr>
                 ...
                 <!-- <td class="not-export-col">
                   <a href="report-usulan.php?page=edit&id_usulan=<?= $row['id_usulan']; ?>" class="btn btn-warning">Edit</a>
                   <a href="report-usulan.php?page=hapus&id_usulan=<?= $row['id_usulan']; ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data')">Hapus</a>
                 </td> -->
               </tr>
             <?php } ?>
           </tbody>
