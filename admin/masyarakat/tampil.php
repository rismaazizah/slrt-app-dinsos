  ...
  <div class="card card-body">
    <div class="row">
      <div class="col-12 d-flex justify-content-between">
        <a href="masyarakat.php?page=tambah" class="btn btn-info">Tambah Data</a>
        ...
        <div class="right">
          ...
          <a href="masyarakat.php?page=export" class="btn btn-info" target="_blank">Print Data</a>
        </div>
      </div>
    </div>
  </div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <a href="masyarakat.php?page=pengajuan&id_masyarakat=<?= $row['id_masyarakat']; ?>" class="btn btn-sm btn-secondary">Pengajuan</a>
                  <a href="masyarakat.php?page=edit&id_masyarakat=<?= $row['id_masyarakat']; ?>" class="btn btn-sm btn-warning">Edit</a>
                  <a href="masyarakat.php?page=hapus&id_masyarakat=<?= $row['id_masyarakat']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data')">Hapus</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="masyarakat.php?page=import" method="post" enctype="multipart/form-data" id="import">
