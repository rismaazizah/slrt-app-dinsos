    ...
    <div class="col-8">
      <div class="card card-body">
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <th style="width: 300px;">Jenis Rujukan</th>
            <td>
              <?php
               if ($row['jenis_rujukan'] == '0' || $row['jenis_rujukan'] == '') {
                 echo 'Belum Ada Rujukan';
                 ...
                 echo 'Badan Amil Zakat Nasional (BAZNAS)';
               } elseif ($row['jenis_rujukan'] == '5') {
                 echo 'Badan Pengelolaan Keuangan dan Aset Daerah (BPKAD)';
               } else {
                 echo $row['jenis_rujukan'];
               }
               ?>
            </td>
          </tr>
