   ...
   <div class="card card-body">
     <div class="row">
       <div class="col-12 d-flex justify-content-between">
         <!-- <a href="konsultasi.php?page=tambah" class="btn btn-primary">Tambah Data</a> -->
         <a href="konsultasi.php?page=export" class="btn btn-info" target="_blank">Print Data</a>
       </div>
     </div>
   </div>
               ...
               <tr>
                 ...
                 <td class="not-export-col">
                   <?php
                    ...
                    ?>
                     <a href="konsultasi.php?page=edit&id_konsultasi=<?= $row['id_konsultasi']; ?>" class="btn btn-info">
