...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Tambah Usulan</h1>
      ...
      <div class="col-12">
        <form action="usulan.php?page=proses" method="post">
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="jenis_usulan" required placeholder="Jenis usulan">
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control textarea" name="kriteria" rows="4"></textarea>
          </div>
