  ...
  <div class="card card-body">
    <div class="row">
      <div class="col-12 d-flex justify-content-between">
        <!-- <a href="kunjungan.php?page=tambah" class="btn btn-primary">Tambah Data</a> -->
        <a href="kunjungan.php?page=export" class="btn btn-info" target="_blank">Print Data</a>
      </div>
    </div>
  </div>
            ...
            ?>
              <tr>
                ...
                <td class="not-export-col">
                  <a href="kunjungan.php?page=edit&id_kunjungan=<?= $row['id_kunjungan']; ?>" class="btn btn-sm btn-warning">Edit</a>
                  <a href="kunjungan.php?page=hapus&id_kunjungan=<?= $row['id_kunjungan']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data')">Hapus</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
