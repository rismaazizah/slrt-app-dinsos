...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Pembuatan Perizinan</h1>
  ...
  <div class="card card-body">
    <div class="row">
      ...
      <div class="col-12">
        <form action="pembuatan-izin.php?page=proses" method="post">

          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label>Nama Perizinan</label>
                <input type="text" class="form-control" name="nama_pembuatan_perizinan" required placeholder="Nama Perizinan">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
